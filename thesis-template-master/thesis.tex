...
The IRC messages dataset has been scraped by Nonnenmacher \cite{Nonnenmacher2017} for his thesis where he has extracted rationale out of the same. The duration until which the data was collected slightly varies with that of issue trackers dataset due to the timeline of research. Comments for issue trackers were scraped until August 2017 while messages from IRC were scraped until May 2017. The following data in Table \ref{tab:rawIRCMessages} are the statistics of the raw data collected. 
\newline
\begin{table} %[hb!]
    \centering
    \begin{adjustbox}{max width=\columnwidth}
