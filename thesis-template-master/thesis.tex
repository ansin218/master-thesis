...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
          &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule 	
        & issue & 0.830 & \textbf{0.945} & \textbf{0.883} & 0.689 & 0.518 & 0.585 & 0.644 & \textbf{0.669} & 0.654 \\
        & alternative & 0.742 & 0.427 & 0.538 & 0.666 & 0.659 & 0.657 & 0.740 & 0.697 & \textbf{0.715} \\ 
        & pro-argument & 0.742 & 0.427 & 0.538 & 0.666 & 0.659 & 0.657 & 0.740 & 0.697 & \textbf{0.715} \\ 
        & con-argument & 0.742 & 0.427 & 0.538 & 0.666 & 0.659 & 0.657 & 0.740 & 0.697 & \textbf{0.715} \\ 
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 1 \\  Config 1 \\ Config 1 \\Config 1  \\ Config 1 } \end{minipage}}
        & decision & 0.742 & 0.427 & 0.538 & 0.666 & 0.659 & 0.657 & 0.740 & 0.697 & \textbf{0.715} \\ 
        \midrule 	
        & issue & 0.830 & \textbf{0.945} & \textbf{0.883} & 0.689 & 0.518 & 0.585 & 0.644 & \textbf{0.669} & 0.654 \\
        & alternative & 0.742 & 0.427 & 0.538 & 0.666 & 0.659 & 0.657 & 0.740 & 0.697 & \textbf{0.715} \\ 
        & pro-argument & 0.742 & 0.427 & 0.538 & 0.666 & 0.659 & 0.657 & 0.740 & 0.697 & \textbf{0.715} \\ 
        & con-argument & 0.742 & 0.427 & 0.538 & 0.666 & 0.659 & 0.657 & 0.740 & 0.697 & \textbf{0.715} \\ 
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 2 \\  Config 12 \\ Config 2 \\Config 2  \\ Config 2 } \end{minipage}}
        & decision & 0.742 & 0.427 & 0.538 & 0.666 & 0.659 & 0.657 & 0.740 & 0.697 & \textbf{0.715} \\ 
        \midrule 	
        & issue & 0.830 & \textbf{0.945} & \textbf{0.883} & 0.689 & 0.518 & 0.585 & 0.644 & \textbf{0.669} & 0.654 \\
        & alternative & 0.742 & 0.427 & 0.538 & 0.666 & 0.659 & 0.657 & 0.740 & 0.697 & \textbf{0.715} \\ 
