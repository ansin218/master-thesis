...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        \toprule
         \multirow{2}{*}{\textbf{Config}} &  \multirow{2}{*}{\textbf{Rationale}} & \multicolumn{3}{c}{Lucene} & \multicolumn{3}{c}{Thunderbird} & \multicolumn{3}{c}{Ubuntu}\\ 
        ...
        \midrule 	
        & with & 0.84 & 0.92 & 0.88 & 0.71 & 0.64 & 0.67 & 0.76 & 0.70 & 0.72 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 1 \\ Config 1} \end{minipage}} &   without & 0.70 & 0.51 & 0.59 & 0.68 & 0.75 & 0.71 & 0.73 & 0.79 & 0.75 \\ 
        \midrule 	
        & with & 0.81 & 0.97  & 0.88 & 0.67 & 0.70 & 0.68 & 0.71 & 0.78 & 0.74 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 2 \\ Config 2} \end{minipage}} &   without & 0.83 & 0.38 & 0.51 & 0.70 & 0.67 & 0.68 & 0.76 & 0.70 & 0.73 \\ 
        \midrule 	
        & with & 0.81 & 0.97  & 0.88 & 0.65 & 0.83 & 0.73 & 0.67 & 0.87 & 0.75 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 3 \\ Config 3} \end{minipage}} &   without & 0.83 & 0.38 & 0.51 & 0.70 & 0.67 & 0.68 & 0.76 & 0.70 & 0.73 \\ 
        \midrule 	
        & with & 0.81 & 0.97  & 0.88 & 0.64 & 0.61 & 0.62 & 0.67 & 0.72 & 0.68 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 4 \\ Config 4} \end{minipage}} &   without & 0.78 & 0.35  & 0.48 & 0.64 & 0.67 & 0.65 & 0.71 & 0.67 & 0.68 \\ 
        \midrule 	
        & with & 0.80 & 0.98  & 0.88 & 0.65 & 0.62 & 0.63 & 0.70 & 0.72 & 0.70 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 5 \\ Config 5} \end{minipage}} &   without & 0.79 & 0.32  & 0.44 & 0.71 & 0.66 & 0.68 & 0.77 & 0.70 & 0.73 \\ 
        \midrule 	
        & with & 0.81 & 0.98  & 0.88 & 0.64 & 0.83 & 0.72 & 0.66 & 0.86 & 0.75 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 6 \\ Config 6} \end{minipage}} &   without & 0.83 & 0.36  & 0.49 & 0.71 & 0.66 & 0.68 & 0.78 & 0.70 & 0.73 \\ 
        \bottomrule
    \end{tabular}
    \end{adjustbox}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
            &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule 	
        & with & 0.80 & 0.97 & 0.88 & 0.61 & 0.81 & 0.69 & 0.65 & 0.82 & 0.72 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 1 \\ Config 1} \end{minipage}} &   without & 0.75 & 0.33 & 0.44 & 0.75 & 0.51 & 0.60 & 0.78 & 0.60 & 0.67 \\ 
        \midrule 	
        & with & 0.79 & 0.99  & 0.88 & 0.64 & 0.74 & 0.68 & 0.67 & 0.80 & 0.72 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 2 \\ Config 2} \end{minipage}} &   without & 0.83 & 0.28 & 0.41 & 0.71 & 0.60 & 0.64 & 0.77 & 0.64 & 0.69 \\ 
        \midrule 	
        & with & 0.79 & 0.99  & 0.88 & 0.63 & 0.78 & 0.69 & 0.68 & 0.82 & 0.74  \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 3 \\ Config 3} \end{minipage}} &   without & 0.83 & 0.28 & 0.41 & 0.71 & 0.60 & 0.64 & 0.77 & 0.64 & 0.69 \\ 
        \midrule 	
        & with & 0.80 & 0.98  & 0.88 & 0.62 & 0.65 & 0.63 & 0.67 & 0.73 & 0.69 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 4 \\ Config 4} \end{minipage}} &   without & 0.82 & 0.31  & 0.43 & 0.65 & 0.62 & 0.63 & 0.72 & 0.66 & 0.68 \\ 
        \midrule 	
        & with & 0.78 & 0.99  & 0.87 & 0.61 & 0.67 & 0.63 & 0.67 & 0.73 & 0.69 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 5 \\ Config 5} \end{minipage}} &   without & 0.83 & 0.23  & 0.34 & 0.71 & 0.61 & 0.65 & 0.78 & 0.64 & 0.70 \\ 
        \midrule 	
        & with & 0.79 & 0.99  & 0.88 & 0.64 & 0.77 & 0.69 & 0.66 & 0.86 & 0.75 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 6 \\ Config 6} \end{minipage}} &   without & 0.88 & 0.28  & 0.40 & 0.71 & 0.60 & 0.65 & 0.78 & 0.63 & 0.69 \\ 
        \bottomrule
    \end{tabular}
    \end{adjustbox}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
            &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule 	
        & with & 0.72 & 0.99 & 0.83 & 0.75 & 0.11 & 0.19 & 0.52 & 0.31 & 0.39 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 1 \\ Config 1} \end{minipage}} &   without & 0.52 & 0.39 & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\ 
        \midrule 	
        & with & 0.72 & 1.00 & 0.83 & 0.03 & 0.10 & 0.05 & 0.52 & 0.31 & 0.39 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 2 \\ Config 2} \end{minipage}} &   without & 0.52 & 0.39 & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\ 
        \midrule 	
        & with & 0.72 & 1.00 & 0.83 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 3 \\ Config 3} \end{minipage}} &   without & 0.52 & 0.39 & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\ 
        \midrule 	
        & with & 0.72 & 1.00 & 0.83 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 4 \\ Config 4} \end{minipage}} &   without & 0.52 & 0.39 & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\ 
        \midrule 	
        & with & 0.72 & 1.00 & 0.83 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 5 \\ Config 5} \end{minipage}} &   without & 0.52 & 0.39 & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\ 
        \midrule 	
        & with & 0.72 & 1.00 & 0.83 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 6 \\ Config 6} \end{minipage}} &   without & 0.52 & 0.39 & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\ 
        \bottomrule
    \end{tabular}
    \end{adjustbox}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
            &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule 	
        & with & 0.82 & 0.93 & 0.87 & 0.65 & 0.60 & 0.62 & 0.74 & 0.62 & 0.67 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 1 \\ Config 1} \end{minipage}} &   without & 0.57 & 0.51 & 0.53 & 0.64 & 0.69 & 0.66 & 0.67 & 0.65 & 0.66 \\ 
        \midrule 	
        & with & 0.82 & 0.93 & 0.87 & 0.62 & 0.60 & 0.61 & 0.72 & 0.65 & 0.68 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 2 \\ Config 2} \end{minipage}} &   without & 0.55 & 0.56 & 0.55 & 0.63 & 0.65 & 0.63 & 0.68 & 0.69 & 0.68 \\ 
        \midrule 	
        & with & 0.83 & 0.94 & 0.88 & 0.60 & 0.46 & 0.42 & 0.75 & 0.52 & 0.61 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 3 \\ Config 3} \end{minipage}} &   without & 0.55 & 0.56 & 0.55 & 0.63 & 0.65 & 0.63 & 0.68 & 0.69 & 0.68 \\ 
        \midrule 	
        & with & 0.83 & 0.91 & 0.87 & 0.60 & 0.55 & 0.57 & 0.71 & 0.48 & 0.67 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 4 \\ Config 4} \end{minipage}} &   without & 0.53 & 0.54 & 0.53 & 0.60 & 0.66 & 0.62 & 0.63 & 0.72 & 0.67 \\ 
        \midrule 	
        & with & 0.84 & 0.84 & 0.84 & 0.65 & 0.48 & 0.55 & 0.72 & 0.49 & 0.58 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 5 \\ Config 5} \end{minipage}} &   without & 0.47 & 0.59 & 0.52 & 0.63 & 0.67 & 0.65 & 0.66 & 0.69 & 0.68 \\ 
        \midrule 	
        & with & 0.83 & 0.93 & 0.87 & 0.62 & 0.47 & 0.53 & 0.65 & 0.58 & 0.61 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 6 \\ Config 6} \end{minipage}} &   without & 0.54 & 0.55 & 0.54 & 0.62 & 0.66 & 0.64 & 0.68 & 0.72 & 0.70 \\ 
        \bottomrule
    \end{tabular}
    \end{adjustbox}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
            &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule 	
        & with & 0.83 & 0.94 & 0.88 & 0.68 & 0.51 & 0.58 & 0.64 & 0.66 & 0.65 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 1 \\ Config 1} \end{minipage}} &   without & 0.74 & 0.42 & 0.53 & 0.66 & 0.65 & 0.65 & 0.74 & 0.69 & 0.71 \\ 
        \midrule 	
        & with & 0.83 & 0.94 & 0.88 & 0.68 & 0.57 & 0.61 & 0.67 & 0.66 & 0.67 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 2 \\ Config 2} \end{minipage}} &   without & 0.78 & 0.40 & 0.52 & 0.68 & 0.62 & 0.64 & 0.76 & 0.67 & 0.71 \\ 
        \midrule 	
        & with & 0.83 & 0.94 & 0.88 & 0.69 & 0.43 & 0.52 & 0.73 & 0.52 & 0.61 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 3 \\ Config 3} \end{minipage}} &   without & 0.78 & 0.40 & 0.52 & 0.68 & 0.62 & 0.64 & 0.76 & 0.67 & 0.71 \\ 
        \midrule 	
        & with & 0.83 & 0.90 & 0.86 & 0.66 & 0.46 & 0.53 & 0.73 & 0.47 & 0.57 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 4 \\ Config 4} \end{minipage}} &   without & 0.68 & 0.48 & 0.56 & 0.62 & 0.70 & 0.75 & 0.65 & 0.77 & 0.71 \\ 
        \midrule
        & with & 0.84 & 0.83 & 0.84 & 0.66 & 0.48 & 0.55 & 0.74 & 0.51 & 0.60 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 5 \\ Config 5} \end{minipage}} &   without & 0.57 & 0.54 & 0.55 & 0.69 & 0.66 & 0.60 & 0.73 & 0.67 & 0.70 \\ 
        \midrule 	
        & with & 0.83 & 0.93 & 0.87 & 0.70 & 0.41 & 0.51 & 0.76 & 0.52 & 0.61 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 6 \\ Config 6} \end{minipage}} &   without & 0.39 & 0.74 & 0.50 & 0.69 & 0.65 & 0.66 & 0.74 & 0.65 & 0.69 \\ 
        \bottomrule
    \end{tabular}
    \end{adjustbox}
