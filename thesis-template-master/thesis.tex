...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
          &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule
        & issue         & 0.141 & 0.151 & 0.258 & 0.608 & 0.331 & 0.488 & 0.661 & 0.422 & 0.580 \\
        & alternative   & 0.674 & 0.528 & 0.657 & 0.618 & 0.260 & 0.410 & 0.625 & 0.268 & 0.421 \\
        & pro-argument  & 0.695 & 0.341 & 0.503 & 0.075 & 0.210 & 0.332 & 0.139 & 0.228 & 0.363 \\
        ...
        & decision      & 0.849 & 0.570 & 0.724 & 0.700 & 0.263 & 0.416 & 0.872 & 0.581 & 0.734 \\
        \midrule
        & issue         & 0.123 & 0.247 & 0.377 & 0.613 & 0.320 & 0.477 & 0.657 & 0.424 & 0.582 \\
        & alternative   & 0.674 & 0.528 & 0.657 & 0.602 & 0.250 & 0.397 & 0.638 & 0.271 & 0.424 \\
        & pro-argument  & 0.686 & 0.350 & 0.512 & 0.076 & 0.214 & 0.338 & 0.134 & 0.217 & 0.349 \\
        & con-argument  & 0.132 & 0.239 & 0.368 & 0.077 & 0.421 & 0.494 & 0.059 & 0.118 & 0.209 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 2 \\  Config 2 \\ Config 2 \\Config 2  \\ Config 2 } \end{minipage}}
        & decision      & 0.879 & 0.594 & 0.743 & 0.677 & 0.263 & 0.416 & 0.875 & 0.598 & 0.748 \\
        \midrule
        ...
        & con-argument  & 0.132 & 0.239 & 0.368 & 0.077 & 0.526 & 0.512 & 0.056 & 0.112 & 0.199 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 3 \\  Config 3 \\ Config 3 \\Config 3  \\ Config 3 } \end{minipage}}
        & decision      & 0.829 & 0.560 & 0.715 & 0.692 & 0.225 & 0.367 & 0.957 & 0.564 & 0.721 \\
        \midrule
        ...
        & decision      & 0.838 & 0.527 & 0.688 & 0.944 & 0.213 & 0.350 & 0.890 & 0.556 & 0.714 \\
        \midrule
        & issue         & 0.118 & 0.340 & 0.457 & 0.323 & 0.607 & 0.479 & 0.645 & 0.402 & 0.561 \\
        & alternative   & 0.672 & 0.541 & 0.666 & 0.207 & 0.532 & 0.340 & 0.204 & 0.468 & 0.556 \\
        & pro-argument  & 0.665 & 0.333 & 0.494 & 0.598 & 0.072 & 0.478 & 0.103 & 0.159 & 0.270 \\
        & con-argument  & 0.137 & 0.366 & 0.480 & 0.820 & 0.076 & 0.322 & 0.058 & 0.112 & 0.199 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 6 \\  Config 6 \\ Config 6 \\Config 6  \\ Config 6 } \end{minipage}}
        & decision      & 0.848 & 0.565 & 0.720 & 0.175 & 0.737 & 0.298 & 0.918 & 0.573 & 0.728 \\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \captionof{table}{Binary Relevance with Logistic Regression and 10-fold Cross Validation}
    \label{tab:fgcBRLR}
\end{table}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
          &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule
        & issue         & 0.305 & 0.232 & 0.372 & 0.544 & 0.447 & 0.616 & 0.619 & 0.553 & 0.682 \\
        & alternative   & 0.656 & 0.652 & 0.729 & 0.578 & 0.360 & 0.522 & 0.534 & 0.407 & 0.568 \\
        & pro-argument  & 0.595 & 0.525 & 0.663 & 0.360 & 0.183 & 0.308 & 0.398 & 0.259 & 0.409 \\
        ...
        & decision      & 0.737 & 0.676 & 0.800 & 0.667 & 0.300 & 0.461 & 0.725 & 0.632 & 0.772 \\
        \midrule
        & issue         & 0.355 & 0.278 & 0.429 & 0.524 & 0.456 & 0.598 & 0.602 & 0.569 & 0.690 \\
        & alternative   & 0.647 & 0.671 & 0.735 & 0.517 & 0.306 & 0.462 & 0.546 & 0.376 & 0.538 \\
        & pro-argument  & 0.613 & 0.549 & 0.682 & 0.277 & 0.147 & 0.256 & 0.377 & 0.212 & 0.348 \\
        & con-argument  & 0.455 & 0.352 & 0.513 & 0.324 & 0.193 & 0.322 & 0.417 & 0.230 & 0.373 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 6 \\  Config 6 \\ Config 6 \\Config 6  \\ Config 6 } \end{minipage}}
        & decision      & 0.788 & 0.647 & 0.781 & 0.722 & 0.325 & 0.490 & 0.771 & 0.632 & 0.772 \\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \captionof{table}{LP - LR - 10-fold CV}
    \label{tab:fgcLPLR}
\end{table}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
          &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule
        & issue         & 0.575 & 0.089 & 0.163 & 0.654 & 0.383 & 0.543 & 0.672 & 0.534 & 0.674 \\
        & alternative   & 0.629 & 0.767 & 0.768 & 0.772 & 0.308 & 0.469 & 0.676 & 0.295 & 0.453 \\
        & pro-argument  & 0.693 & 0.453 & 0.612 & 0.556 & 0.045 & 0.085 & 0.538 & 0.074 & 0.138 \\
        & con-argument  & 0.640 & 0.113 & 0.202 & 0.735 & 0.110 & 0.198 & 0.682 & 0.099 & 0.180 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 1 \\  Config 1 \\ Config 1 \\Config 1  \\ Config 1 } \end{minipage}}
        & decision      & 0.926 & 0.483 & 0.651 & 0.769 & 0.125 & 0.222 & 0.922 & 0.404 & 0.670 \\
        \midrule
        ...
        & decision      & 0.471 & 0.812 & 0.860 & 0.145 & 0.500 & 0.648 & 0.576 & 0.581 & 0.730 \\
        \midrule
        & issue         & 0.319 & 0.350 & 0.495 & 0.458 & 0.594 & 0.673 & 0.549 & 0.691 & 0.748 \\
        & alternative   & 0.549 & 0.816 & 0.728 & 0.385 & 0.618 & 0.703 & 0.442 & 0.549 & 0.676 \\
        & pro-argument  & 0.444 & 0.783 & 0.750 & 0.195 & 0.429 & 0.572 & 0.299 & 0.201 & 0.333 \\
        & con-argument  & 0.249 & 0.585 & 0.664 & 0.233 & 0.513 & 0.644 & 0.341 & 0.382 & 0.546 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 6 \\  Config 6 \\ Config 6 \\Config 6  \\ Config 6 } \end{minipage}}
        & decision      & 0.546 & 0.749 & 0.835 & 0.205 & 0.450 & 0.611 & 0.931 & 0.573 & 0.728 \\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \captionof{table}{Binary Relevance with Multinomial Naive Bayes and 10-fold Cross Validation}
    \label{tab:fgcBRMNB}
\end{table}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
          &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule
        & issue         & 0.378 & 0.270 & 0.421 & 0.493 & 0.606 & 0.690 & 0.546 & 0.748 & 0.771 \\
        & alternative   & 0.590 & 0.769 & 0.747 & 0.550 & 0.407 & 0.568 & 0.557 & 0.344 & 0.505 \\
        & pro-argument  & 0.582 & 0.580 & 0.700 & 0.342 & 0.116 & 0.208 & 0.380 & 0.101 & 0.182 \\
        ...
        \midrule
        & issue         & 0.379 & 0.278 & 0.430 & 0.487 & 0.546 & 0.654 & 0.563 & 0.636 & 0.723 \\
        & alternative   & 0.592 & 0.705 & 0.728 & 0.373 & 0.587 & 0.683 & 0.384 & 0.615 & 0.706 \\
        & pro-argument  & 0.508 & 0.624 & 0.712 & 0.214 & 0.371 & 0.524 & 0.250 & 0.381 & 0.538 \\
        & con-argument  & 0.290 & 0.468 & 0.604 & 0.240 & 0.456 & 0.602 & 0.222 & 0.395 & 0.552 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 2 \\  Config 2 \\ Config 2 \\Config 2  \\ Config 2 } \end{minipage}}
        & decision      & 0.626 & 0.734 & 0.832 & 0.224 & 0.438 & 0.601 & 0.773 & 0.581 & 0.733 \\
        \midrule
        & issue         & 0.371 & 0.216 & 0.430 & 0.540 & 0.466 & 0.608 & 0.620 & 0.568 & 0.692 \\
        & alternative   & 0.657 & 0.617 & 0.736 & 0.571 & 0.339 & 0.500 & 0.549 & 0.385 & 0.548 \\
        & pro-argument  & 0.589 & 0.223 & 0.648 & 0.333 & 0.188 & 0.314 & 0.434 & 0.259 & 0.410 \\
        ...
        & pro-argument  & 0.491 & 0.589 & 0.688 & 0.196 & 0.362 & 0.513 & 0.226 & 0.402 & 0.556 \\
        & con-argument  & 0.257 & 0.366 & 0.514 & 0.233 & 0.417 & 0.568 & 0.163 & 0.283 & 0.432 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 5 \\  Config 5 \\ Config 5 \\Config 5  \\ Config 5 } \end{minipage}}
        & decision      & 0.561 & 0.758 & 0.842 & 0.185 & 0.450 & 0.610 & 0.593 & 0.573 & 0.724 \\
        \midrule
        & issue         & 0.383 & 0.239 & 0.383 & 0.490 & 0.581 & 0.676 & 0.534 & 0.734 & 0.761 \\
        & alternative   & 0.592 & 0.773 & 0.750 & 0.516 & 0.370 & 0.530 & 0.549 & 0.371 & 0.533 \\
        & pro-argument  & 0.573 & 0.564 & 0.687 & 0.316 & 0.112 & 0.200 & 0.447 & 0.090 & 0.165 \\
        & con-argument  & 0.455 & 0.299 & 0.456 & 0.423 & 0.193 & 0.322 & 0.400 & 0.092 & 0.169 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 6 \\  Config 6 \\ Config 6 \\Config 6  \\ Config 6 } \end{minipage}}
        & decision      & 0.726 & 0.614 & 0.754 & 0.643 & 0.225 & 0.367 & 0.928 & 0.547 & 0.707 \\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \captionof{table}{LP - MNB - 10-fold CV}
    \label{tab:fgcLPMNB}
\end{table}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
          &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule
        & issue         & 0.427 & 0.305 & 0.462 & 0.625 & 0.560 & 0.688 & 0.688 & 0.624 & 0.740 \\
        & alternative   & 0.709 & 0.651 & 0.742 & 0.602 & 0.496 & 0.649 & 0.652 & 0.512 & 0.666 \\
        & pro-argument  & 0.645 & 0.580 & 0.708 & 0.413 & 0.286 & 0.441 & 0.441 & 0.275 & 0.429 \\
        & con-argument  & 0.474 & 0.391 & 0.553 & 0.547 & 0.360 & 0.526 & 0.449 & 0.289 & 0.447 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 1 \\  Config 1 \\ Config 1 \\Config 1  \\ Config 1 } \end{minipage}}
        & decision      & 0.808 & 0.691 & 0.812 & 0.743 & 0.325 & 0.490 & 0.813 & 0.667 & 0.798 \\
        \midrule
        ...
        & con-argument  & 0.420 & 0.359 & 0.519 & 0.372 & 0.294 & 0.450 & 0.431 & 0.368 & 0.534 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 6 \\  Config 6 \\ Config 6 \\Config 6  \\ Config 6 } \end{minipage}}
        & decision      & 0.732 & 0.647 & 0.779 & 0.519 & 0.338 & 0.504 & 0.755 & 0.684 & 0.809 \\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \captionof{table}{BR - SVM - 10-fold CV}
    \label{tab:fgcBRSVM}
\end{table}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        & pro-argument  & 0.609 & 0.560 & 0.690 & 0.268 & 0.232 & 0.373 & 0.371 & 0.275 & 0.428 \\
        & con-argument  & 0.473 & 0.401 & 0.563 & 0.424 & 0.320 & 0.481 & 0.477 & 0.342 & 0.507 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 6 \\  Config 6 \\ Config 6 \\Config 6  \\ Config 6 } \end{minipage}}
        & decision      & 0.809 & 0.614 & 0.757 & 0.703 & 0.325 & 0.490 & 0.765 & 0.667 & 0.797 \\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \captionof{table}{LP - SVM - 10-fold CV}
    \label{tab:fgcLPSVM}
\end{table}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 1 \\  Config 1 \\ Config 1 \\Config 1  \\ Config 1 } \end{minipage}}
        & decision      & 0.852 & 0.502 & 0.667 & 0.917 & 0.138 & 0.242 & 0.897 & 0.521 & 0.685 \\
        \midrule
        & issue         & 0.571 & 0.031 & 0.060 & 0.526 & 0.229 & 0.368 & 0.553 & 0.320 & 0.474 \\
        & alternative   & 0.618 & 0.473 & 0.608 & 0.436 & 0.134 & 0.236 & 0.471 & 0.100 & 0.181 \\
        & pro-argument  & 0.693 & 0.333 & 0.495 & 0.438 & 0.031 & 0.061 & 0.583 & 0.074 & 0.138 \\
        ...
        & alternative   & 0.623 & 0.452 & 0.592 & 0.446 & 0.145 & 0.252 & 0.455 & 0.085 & 0.157 \\
        & pro-argument  & 0.696 & 0.337 & 0.499 & 0.438 & 0.031 & 0.061 & 0.425 & 0.090 & 0.165 \\
        & con-argument  & 0.426 & 0.081 & 0.150 & 0.227 & 0.022 & 0.043 & 0.333 & 0.026 & 0.051 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 3 \\  Config 3 \\ Config 3 \\Config 3  \\ Config 3 } \end{minipage}}
        & decision      & 0.851 & 0.498 & 0.663 & 1.000 & 0.163 & 0.280 & 0.901 & 0.547 & 0.707 \\
        \midrule
        ...
        & decision      & 0.813 & 0.440 & 0.609 & 0.929 & 0.163 & 0.280 & 0.887 & 0.438 & 0.699 \\
        \midrule
        & issue         & 0.636 & 0.027 & 0.053 & 0.513 & 0.245 & 0.387 & 0.560 & 0.265 & 0.413 \\
        & alternative   & 0.599 & 0.475 & 0.606 & 0.523 & 0.140 & 0.246 & 0.500 & 0.132 & 0.232 \\
        & pro-argument  & 0.668 & 0.326 & 0.486 & 0.200 & 0.004 & 0.009 & 0.550 & 0.058 & 0.110 \\
        & con-argument  & 0.453 & 0.085 & 0.156 & 0.667 & 0.018 & 0.034 & 0.333 & 0.026 & 0.051 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 6 \\  Config 6 \\ Config 6 \\Config 6  \\ Config 6 } \end{minipage}}
        & decision      & 0.735 & 0.469 & 0.635 & 0.800 & 0.150 & 0.261 & 0.890 & 0.556 & 0.714 \\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \captionof{table}{BR - DT - 10-fold CV}
    \label{tab:fgcBRDT}
\end{table}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
          &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule
        & issue         & 0.243 & 0.212 & 0.345 & 0.403 & 0.257 & 0.298 & 0.440 & 0.392 & 0.533 \\
        & alternative   & 0.522 & 0.635 & 0.667 & 0.442 & 0.143 & 0.248 & 0.476 & 0.122 & 0.217 \\
        & pro-argument  & 0.541 & 0.230 & 0.370 & 0.333 & 0.040 & 0.077 & 0.350 & 0.074 & 0.138 \\
        & con-argument  & 0.321 & 0.120 & 0.213 & 0.105 & 0.009 & 0.017 & 0.400 & 0.053 & 0.100 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 1 \\  Config 1 \\ Config 1 \\Config 1  \\ Config 1 } \end{minipage}}
        & decision      & 0.876 & 0.512 & 0.676 & 0.583 & 0.175 & 0.298 & 0.877 & 0.547 & 0.706 \\
        \midrule
        ...
        & con-argument  & 0.275 & 0.127 & 0.224 & 0.105 & 0.009 & 0.017 & 0.448 & 0.342 & 0.507 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 2 \\  Config 2 \\ Config 2 \\Config 2  \\ Config 2 } \end{minipage}}
        & decision      & 0.858 & 0.527 & 0.688 & 0.583 & 0.175 & 0.298 & 0.877 & 0.547 & 0.706 \\
        \midrule
        & issue         & 0.247 & 0.216 & 0.350 & 0.403 & 0.257 & 0.298 & 0.440 & 0.392 & 0.533 \\
        & alternative   & 0.513 & 0.617 & 0.656 & 0.442 & 0.143 & 0.248 & 0.476 & 0.122 & 0.217 \\
        & pro-argument  & 0.517 & 0.223 & 0.360 & 0.333 & 0.040 & 0.077 & 0.350 & 0.074 & 0.138 \\
        ...
        & decision      & 0.736 & 0.618 & 0.758 & 0.484 & 0.188 & 0.316 & 0.863 & 0.538 & 0.699 \\
        \midrule
        & issue         & 0.216 & 0.178 & 0.298 & 0.396 & 0.238 & 0.375 & 0.475 & 0.367 & 0.516 \\
        & alternative   & 0.525 & 0.639 & 0.670 & 0.445 & 0.126 & 0.223 & 0.561 & 0.112 & 0.201 \\
        & pro-argument  & 0.531 & 0.252 & 0.398 & 0.114 & 0.018 & 0.035 & 0.238 & 0.026 & 0.052 \\
        & con-argument  & 0.355 & 0.134 & 0.235 & 0.162 & 0.026 & 0.051 & 0.258 & 0.053 & 0.100 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 6 \\  Config 6 \\ Config 6 \\Config 6  \\ Config 6 } \end{minipage}}
        & decision      & 0.355 & 0.488 & 0.654 & 0.621 & 0.225 & 0.367 & 0.847 & 0.521 & 0.684 \\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \captionof{table}{LP - DT - 10-fold CV}
    \label{tab:fgcLPDT}
\end{table}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
          &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule
        & issue         & 1.000 & 0.093 & 0.170 & 0.526 & 0.229 & 0.368 & 0.882 & 0.326 & 0.490 \\
        & alternative   & 0.824 & 0.507 & 0.660 & 0.436 & 0.134 & 0.236 & 0.976 & 0.195 & 0.326 \\
        & pro-argument  & 0.920 & 0.298 & 0.459 & 0.438 & 0.031 & 0.061 & 1.000 & 0.116 & 0.209 \\
        & con-argument  & 0.911 & 0.144 & 0.252 & 0.188 & 0.013 & 0.026 & 0.852 & 0.151 & 0.263 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 1 \\  Config 1 \\ Config 1 \\Config 1  \\ Config 1 } \end{minipage}}
        & decision      & 0.965 & 0.536 & 0.698 & 0.917 & 0.138 & 0.242 & 0.947 & 0.607 & 0.755 \\
        \midrule
        & issue         & 1.000 & 0.097 & 0.176 & 0.892 & 0.187 & 0.315 & 0.909 & 0.319 & 0.482 \\
        & alternative   & 0.831 & 0.523 & 0.673 & 0.935 & 0.178 & 0.302 & 0.976 & 0.198 & 0.330 \\
        & pro-argument  & 0.911 & 0.300 & 0.461 & 0.879 & 0.129 & 0.229 & 1.000 & 0.116 & 0.209 \\
        & con-argument  & 0.911 & 0.144 & 0.252 & 0.921 & 0.154 & 0.266 & 0.857 & 0.158 & 0.273 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 2 \\  Config 2 \\ Config 2 \\Config 2  \\ Config 2 } \end{minipage}}
        & decision      & 0.947 & 0.517 & 0.681 & 1.000 & 0.300 & 0.462 & 0.947 & 0.607 & 0.755 \\
        \midrule
        & issue         & 0.960 & 0.093 & 0.170 & 0.859 & 0.236 & 0.380 & 0.812 & 0.389 & 0.555 \\
        & alternative   & 0.772 & 0.603 & 0.725 & 0.919 & 0.188 & 0.316 & 0.933 & 0.205 & 0.340 \\
        & pro-argument  & 0.882 & 0.343 & 0.509 & 0.806 & 0.112 & 0.201 & 1.000 & 0.106 & 0.191 \\
        & con-argument  & 0.915 & 0.151 & 0.263 & 0.950 & 0.167 & 0.286 & 0.862 & 0.164 & 0.282 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 3 \\  Config 3 \\ Config 3 \\Config 3  \\ Config 3 } \end{minipage}}
        & decision      & 0.946 & 0.507 & 0.672 & 1.000 & 0.300 & 0.462 & 0.923 & 0.615 & 0.761 \\
        \midrule
        ...
        & con-argument  & 0.917 & 0.155 & 0.268 & 0.944 & 0.149 & 0.260 & 0.857 & 0.158 & 0.273 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 6 \\  Config 6 \\ Config 6 \\Config 6  \\ Config 6 } \end{minipage}}
        & decision      & 0.955 & 0.512 & 0.677 & 1.000 & 0.263 & 0.416 & 0.947 & 0.607 & 0.755 \\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \captionof{table}{BR - RF - 10-fold CV}
    \label{tab:fgcBRRF}
\end{table}
...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
          &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule
        & issue         & 0.489 & 0.170 & 0.290 & 0.681 & 0.309 & 0.467 & 0.648 & 0.514 & 0.656 \\
        & alternative   & 0.630 & 0.786 & 0.775 & 0.946 & 0.182 & 0.308 & 0.943 & 0.200 & 0.333 \\
        & pro-argument  & 0.731 & 0.370 & 0.534 & 0.879 & 0.129 & 0.229 & 0.952 & 0.106 & 0.191 \\
        & con-argument  & 0.674 & 0.218 & 0.357 & 0.907 & 0.171 & 0.292 & 0.828 & 0.158 & 0.273 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 1 \\  Config 1 \\ Config 1 \\Config 1  \\ Config 1 } \end{minipage}}
        & decision      & 0.842 & 0.565 & 0.720 & 1.000 & 0.325 & 0.491 & 0.913 & 0.624 & 0.768 \\
        \midrule
        ...
        & alternative   & 0.688 & 0.621 & 0.720 & 0.649 & 0.298 & 0.455 & 0.637 & 0.278 & 0.432 \\
        & pro-argument  & 0.679 & 0.444 & 0.603 & 0.486 & 0.152 & 0.263 & 0.458 & 0.143 & 0.250 \\
        & con-argument  & 0.430 & 0.204 & 0.337 & 0.652 & 0.189 & 0.317 & 0.500 & 0.178 & 0.301 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 4 \\  Config 4 \\ Config 4 \\Config 4  \\ Config 4 } \end{minipage}}
        & decision      & 0.759 & 0.686 & 0.807 & 0.920 & 0.288 & 0.447 & 0.871 & 0.632 & 0.774 \\
        \midrule
        & issue         & 0.367 & 0.224 & 0.363 & 0.559 & 0.312 & 0.466 & 0.631 & 0.491 & 0.636 \\
        & alternative   & 0.688 & 0.621 & 0.720 & 0.649 & 0.298 & 0.455 & 0.637 & 0.278 & 0.432 \\
        & pro-argument  & 0.679 & 0.444 & 0.603 & 0.486 & 0.152 & 0.263 & 0.458 & 0.143 & 0.250 \\
        ...
        & decision      & 0.759 & 0.686 & 0.807 & 0.920 & 0.288 & 0.447 & 0.871 & 0.632 & 0.774 \\
        \midrule
        & issue         & 0.554 & 0.139 & 0.244 & 0.642 & 0.293 & 0.448 & 0.676 & 0.501 & 0.649 \\
        ...
        & con-argument  & 0.683 & 0.197 & 0.329 & 0.925 & 0.162 & 0.279 & 0.833 & 0.164 & 0.282 \\
        \multirow{-5}{*}{\begin{minipage}{4cm}{\scriptsize  Config 6 \\  Config 6 \\ Config 6 \\Config 6  \\ Config 6 } \end{minipage}}
        & decision      & 0.905 & 0.551 & 0.709 & 1.000 & 0.275 & 0.431 & 0.948 & 0.624 & 0.768 \\
        \bottomrule
    \end{tabular}
    \end{adjustbox}
    \captionof{table}{LP - RF - 10-fold CV}
    \label{tab:fgcLPRF}
\end{table}
