...
Therefore, for the main content analysis, two annotators individually read through XXXX number of individual sentences from XXXX comments comprising of 100 issues from each of the three projects. Although the number of issues fetched for each of them were much higher, only 100 of them were attained for each project using random stratified sampling due to time constraints of the research. 
