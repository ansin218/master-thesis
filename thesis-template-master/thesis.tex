...
Latent Dirichilet Allocation (LDA) is a topic modeling algorithm introduced by Blei at al. \cite{Blei2003}, where topics are formed using a generative process. The pseudocode of LDA has been adapted from Goel \cite{Goel2017} and is described as follows.
...
\newline \newline
SVM has been used in the past for various text classification projects. In addition to the thesis, works of Lata \cite{Lata2016} and Nonnenmacher\cite{Nonnenmacher2017}, Fan et al.\cite{Fan2017}, Guzman et al.\cite{Guzman2016} and Bacchelli et al.\cite{Bacchelli2012} have also used SVM for text classification tasks. 
...
\end{equation}
The pseudocode of DT is described as follows. 
\begin{algorithm}
...
\begin{itemize}
\item[\textbf{RH1}] Comments from ITS of OSS projects contain rationale.
\end{itemize}
...
\begin{itemize}
\item[\textbf{RH3}] Common topics are discussed on IRC as well as ITS.
\end{itemize}
