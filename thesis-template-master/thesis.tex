...
The data management module acts as the starting point for the architecture. It consists of a SQL \textit{database} artifact which stores raw data such as comments of issue tracking systems scraped from different sources besides \acs{IRC} messages. The DataScraper is responsible for scraping data while the DataLabeler aids in sampling data and then labeling it. 
