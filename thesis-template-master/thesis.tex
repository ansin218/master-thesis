...
\begin{figure}[h] %b!]
    \centering
    \includegraphics[width=15cm]{methodology}
...
\begin{figure}[h] %b!]
    \centering
    \includegraphics[width=12cm]{ibis-model}
    \caption{IBIS model demonstrated using UML class diagram}
    \label{fig:ibisModel}
\end{figure}
...
\begin{figure}[h] %b!]
    ...
    \caption{Fine tuned model demonstrated using UML class diagram}
