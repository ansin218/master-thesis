...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
            &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule 	
        & with & 80 & 97 & 88 & 61 & 81 & 69 & 65 & 82 & 72 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 1 \\ Config 1} \end{minipage}} &   without & 75 & 33 & 44 & 75 & 51 & 60& 78 & 60 & 67 \\ 
        \midrule 	
        & with & 79 & 99  & 88 & 64 & 74 & 68 & 67 & 80 & 72 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 2 \\ Config 2} \end{minipage}} &   without & 83 & 28 & 41 & 71 & 60 & 64 & 77 & 64 & 69 \\ 
        \midrule 	
        & with & 79 & 99  & 88 & 63 & 78 & 69 & 68 & 82 & 74  \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 3 \\ Config 3} \end{minipage}} &   without & 83 & 28 & 41 & 71 & 60 & 64 & 77 & 64 & 69 \\ 
        \midrule 	
        & with & 80 & 98  & 88 & 62 & 65 & 63 & 67 & 73 & 69 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 4 \\ Config 4} \end{minipage}} &   without & 82 & 31  & 43 & 65 & 62 & 63 & 72 & 66 & 68 \\ 
        \midrule 	
        & with & 78 & 99  & 87 & 61 & 67 & 63 & 67 & 73 & 69 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 5 \\ Config 5} \end{minipage}} &   without & 83 & 23  & 34 & 71 & 61 & 65 & 78 & 64 & 70 \\ 
        \midrule 	
        & with & 79 & 99  & 88 & 64 & 77 & 69 & 66 & 86 & 75 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 6 \\ Config 6} \end{minipage}} &   without & 88 & 28  & 40 & 71 & 60 & 65 & 78 & 63 & 69 \\ 
        \bottomrule
    \end{tabular}
    \end{adjustbox}
