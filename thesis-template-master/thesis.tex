...
\newline \newline
Topic modeling using \acs{LDA} was performed using a famous library named Gensim\footnote{\url{https://radimrehurek.com/gensim/}}. Rehurek and Sojka \cite{Rehurek2010} published their work on the internal details of how Gensim works as well. Keywords generated using \acs{LDA} for comments of \acs{ITS} and messages of \acs{IRC} were linked using a string similarity Python library called fuzzywuzzy\footnote{\url{http://chairnerd.seatgeek.com/fuzzywuzzy-fuzzy-string-matching-in-python/}} based on Levenshtein distance.
\newline \newline
