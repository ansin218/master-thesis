...
\begin{itemize}
\item[\textbf{RH1}] \textit{Messages from ITS of OSS projects contain rationale.} Something here.  
\item[\textbf{RH2}] \textit{Something here} Something here.  
\item[\textbf{RH3}] \textit{Something here} Something here.  
\end{itemize}
