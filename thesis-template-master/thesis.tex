...
Bachelli et al. used a dataset of around 1,500 emails from mailing lists. They then tried to classify the contents of the emails into 5 categories: natural language, junk, patch, stack trace and source code, using Naive Bayes classifier. 

\subsection{Topic Modeling of Rationale Elements}
