...
\item[\textbf{RH3}] \textit{Common topics are discussed on \acs{IRC}s as well as issue tracking systems.} There exists certain issues that are possibly discussed in both, \acs{IRC} channel as well as issue tracking system. These issues could therefore be linked together to link related rationale.    
\end{itemize}
