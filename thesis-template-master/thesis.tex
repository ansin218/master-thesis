...
\begin{table}[h] %[hb!]
    ...
    \begin{tabular}{L{1.5cm} c ccc | ccc | ccc }
        ...
        \cmidrule(l){3-5} \cmidrule(l){6-8} \cmidrule(l){9-11}
            &  & \textbf{Pr} &  \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} & \textbf{Pr} & \textbf{Re} & \textbf{F1} \\
        \midrule 	
        & with & 0.52 & \textbf{0.31} & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 1 \\ Config 1} \end{minipage}} &   without & 0.52 & \textbf{0.31} & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\ 
        \midrule 	
        & with & 0.52 & \textbf{0.31} & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 2 \\ Config 2} \end{minipage}} &   without & 0.52 & \textbf{0.31} & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\ 
        \midrule 	
        & with & 0.52 & \textbf{0.31} & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 3 \\ Config 3} \end{minipage}} &   without & 0.52 & \textbf{0.31} & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\ 
        \midrule 	
        & with & 0.52 & \textbf{0.31} & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 4 \\ Config 4} \end{minipage}} &   without & 0.52 & \textbf{0.31} & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\ 
        \midrule 	
        & with & 0.52 & \textbf{0.31} & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 5 \\ Config 5} \end{minipage}} &   without & 0.52 & \textbf{0.31} & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\ 
        \midrule 	
        & with & 0.52 & \textbf{0.31} & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\
        \multirow{-2}{*}{\begin{minipage}{4cm}{\scriptsize Config 6 \\ Config 6} \end{minipage}} &   without & 0.52 & \textbf{0.31} & 0.39 & 0.52 & 0.31 & 0.39 & 0.52 & 0.31 & 0.39 \\ 
        \bottomrule
    \end{tabular}
    \end{adjustbox}
