...
for x in range(len(lucene_rss_list)):
	...
	customList21 = ['tested', 'anythings', 'forms', 'help', 'easily', 'write', 'writes', 'lot', 'lots', 'aspect', 'comments', 'committing', 'thing']
	customList22 = ['quick', 'keep', 'everything', 'non', 'correct', 'correctly', 'simple', 'clear', 'didnt', 'didn', 'time', 'times', 'likely', 'oh']
