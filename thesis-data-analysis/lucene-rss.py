...
for i in range(len(final_list_1)):
    ...
    for row in cursor_1:
        ...
        for j in range(len(cleancomment)):
            try:
                insert_cursor_1.execute("""INSERT INTO lucene_rss (comment_id, title, root_comment, comment, author, reporter, assignee, tagged) VALUES ("%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s")""" % (issue_id, current_title, root_comment, cleancomment[j], author, reporter, assignee, tagged))
            except:
                print()
        print("\n")
...
for i in range(len(final_list_2)):
    ...
    for row in cursor_2:
        ...
        for j in range(len(cleancomment)):
            try:
                insert_cursor_2.execute("""INSERT INTO lucene_rss (comment_id, title, root_comment, comment, author, reporter, assignee, tagged) VALUES ("%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s")""" % (issue_id, current_title, root_comment, cleancomment[j], author, reporter, assignee, tagged))
            except:
                print()
        print("\n")
...
for i in range(len(final_list_3)):
    ...
    for row in cursor_3:
        ...
        for j in range(len(cleancomment)):
            try:
                insert_cursor_3.execute("""INSERT INTO lucene_rss (comment_id, title, root_comment, comment, author, reporter, assignee, tagged) VALUES ("%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s")""" % (issue_id, current_title, root_comment, cleancomment[j], author, reporter, assignee, tagged))
            except:
                print()
        print("\n")
...
for i in range(len(final_list_4)):
    ...
    for row in cursor_4:
        ...
        for j in range(len(cleancomment)):
            try:
                insert_cursor_4.execute("""INSERT INTO lucene_rss (comment_id, title, root_comment, comment, author, reporter, assignee, tagged) VALUES ("%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s")""" % (issue_id, current_title, root_comment, cleancomment[j], author, reporter, assignee, tagged))
            except:
                print()
        print("\n")
...
for i in range(len(final_list_5)):
    ...
    for row in cursor_5:
        ...
        for j in range(len(cleancomment)):
            try:
                insert_cursor_5.execute("""INSERT INTO lucene_rss (comment_id, title, root_comment, comment, author, reporter, assignee, tagged) VALUES ("%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s")""" % (issue_id, current_title, root_comment, cleancomment[j], author, reporter, assignee, tagged))
            except:
                print()
        print("\n")
