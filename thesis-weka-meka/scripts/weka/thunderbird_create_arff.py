...
cursor.execute('SELECT sentence, isRelevant FROM c_thunderbird_results')
...
arff.dump('Thunderbird_binary.arff', data, relation="rationale", names=['sentence',  'classification'])
