...
cursor.execute('SELECT sentence, isRelevant FROM c_thunderbird_pos_results')
...
arff.dump('Thunderbird_binary_pos.arff', data, relation="rationale", names=['sentence',  'classification'])
