...
cursor.execute('SELECT sentence, isRelevant FROM a_lucene_pos_results')
...
arff.dump('Lucene_binary_pos.arff', data, relation="rationale", names=['sentence',  'classification'])
