...
cursor.execute('SELECT * FROM c_thunderbird_results')
...
arff.dump('thunderbird_finegrained.arff', data, relation='rationale', names=['id','c_rss_id','comment_id','issue_id','comment','sentence','author','tagged','isRelevant','label','isIssue','isAlternative','isPro','isCon','isDecision'])
